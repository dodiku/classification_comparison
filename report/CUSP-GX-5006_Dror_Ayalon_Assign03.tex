...
\begin{abstract}
Classification in on of the major tasks in machine learning. This study compares the restuls of multiple classification algorithms, to find the most effective technique for the given dataset.
